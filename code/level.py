...
class Level:
    def __init__(self, tmx_map, level_frames, data):
        ...
        bg_name = tmx_level_properties.get('bg')
        bg_tile = level_frames['bg_tiles'].get(bg_name) or level_frames['bg_tiles'].get('Blue')
        ...
        self.damege_sprites = pygame.sprite.Group()
    ...
    def setup(self, tmx_map, level_frames):
       ...
       for obj in tmx_map.get_layer_by_name('Moving Objects'):
           if obj.name == 'spike':
               Spike(
                   ...
                   groups = (self.all_sprites, self.damege_sprites))
               ...
               groups = (self.all_sprites, self.semi_collision_sprites) if obj.properties['platform'] else (self.all_sprites, self.damege_sprites)
       ...
       for obj in tmx_map.get_layer_by_name('Enemies'):
           if obj.name == 'tooth':
              Tooth((obj.x, obj.y), level_frames['tooth'], (self.all_sprites, self.damege_sprites, self.tooth_sprites), self.collision_sprites)
           if obj.name == 'shell':
              Shell(
                  pos = (obj.x, obj.y),
